...
var s = { isPrimitive: true, match: (t2) => "string" == typeof t2, fromHexString: i, toHexString: i };
var r = { isPrimitive: true, match: (t2) => "number" == typeof t2, fromHexString: (t2) => parseInt(t2.substring(1), 16), toHexString: (t2) => "#" + t2.toString(16).padStart(6, 0) };
...
var d = class extends t {
  ...
  _initInput() {
    ...
    this.$input.addEventListener("focus", () => {
      ...
      "Enter" === e2.code && this.$input.blur(), "ArrowUp" === e2.code && (e2.preventDefault(), t2(this._step * this._arrowKeyMultiplier(e2))), "ArrowDown" === e2.code && (e2.preventDefault(), t2(-1 * this._step * this._arrowKeyMultiplier(e2)));
...
var c = class extends t {
  ...
  updateDisplay() {
    ...
    return this.$select.selectedIndex = e2, this.$display.innerHTML = -1 === e2 ? t2 : this._names[e2], this;
  }
};
...
var p = false;
var g = class {
  constructor({ parent: t2, autoPlace: e2 = void 0 === t2, touchStyles: i2 = true, container: s2, injectStyles: r2 = true, title: n2 = "Controls", width: l2 } = {}) {
...
// dep:three_examples__jsm_libs_lil-gui_module_min_js
 ...
 * @license MIT
 */
//# sourceMappingURL=three_examples__jsm_libs_lil-gui_module_min_js.js.map
